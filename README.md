...
Podés usar los plugins `Jest` que los ejecuta dentro de tu editor, o bien el `Jest Runner` que te da la opción de ejecutar o debuggear un test. Y por último, desde el Git Bash o la línea de comando:
